	...
	return (
		<Modal active={infoModalActive} hideCallback={hideModal}>
			...
			<div className="head-text-2">
				This tool is currently in BETA testing. Please <a href="mailto:calculator@be-exchange.org">email us</a>{' '}
				with comments or bug reports.
			</div>
			...
			<div className="instructions-container">
				...
				<div className="head-text-4">
					<p>
						...
						. Input annual utility information and building characteristics to generate emissions thresholds
						and resulting estimated penalties for three major penalty periods (2024-2029, 2030-2034, and
						2035 and later).
					</p>
					<p>
						...
						demystify the Climate Mobilization Act and connect our community to solutions. The calculator
						engine was developed by AKF Group LLC with UX/UI design by Jessica Celano.
					</p>
			...
			<div className="instructions-container">
				...
				<ol className="head-text-4">
					...
					<li>
						Enter your annual utility rate for each fuel source (total annual utility cost divided by total
						annual consumption).
					</li>
					<li>
